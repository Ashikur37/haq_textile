...
/* global btoa */ (function(root) {
    ...
    function getWholeCharAndI(str, i) {
        ...
        /* istanbul ignore if */ if (isNaN(code)) {
        ...
        if (code < 0xD800 || code > 0xDFFF) {
            return [
                str.charAt(i),
                i
            ] // Non-surrogate character, keeping 'i' the same
            ;
        }
        // High surrogate
        ...
        /* istanbul ignore else */ if (prev < 0xD800 || prev > 0xDBFF) {
            // Low surrogate without preceding high surrogate
            return [
                " ",
                i
        ...
        /* istanbul ignore next */ throw new Error('String "' + str + '" reaches code believed to be unreachable; please open an issue at https://github.com/Trott/slug/issues/new');
    }
    if (false) {} else {
